...
from .models import User, Project, Like, Comment, PortfolioDesign, Profile, Template, Announcement, Category, SiteContent
...
class UserSerializer(serializers.ModelSerializer):
    ...
    def get_cover_url(self, obj):
        try:
            profile = obj.profile_extra
            if profile.cover_data_url: return profile.cover_data_url
        except Profile.DoesNotExist: pass
        if obj.cover:
            request = self.context.get('request')
...
class CommentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Comment
        fields = ['id','text','author_name','author_email','at']
...
class ProfileSerializer(serializers.ModelSerializer):
    class Meta:
        model = Profile
        fields = [
            'about_bio','about_interests','about_languages',
            'about_github','about_linkedin',
            'resume_data','resume_template',
            'avatar_data_url','cover_data_url',
        ]
